...
size_t binary_tree_height_c(const binary_tree_t *tree)
{
	...
	if (tree == NULL)
		return (0);
	left_height = binary_tree_height_c(tree->left);
	right_height = binary_tree_height_c(tree->right);
...
int binary_tree_balance(const binary_tree_t *tree)
{
	...
	if (tree == NULL)
		return (0);
	left_height = (int)binary_tree_height_c(tree->left);
	right_height = (int)binary_tree_height_c(tree->right);
